...
#     h3indexhashmap[element] = {"description": "", "hasbusinessinfo": False ,"businesses": [], "businesscount": 0}
...
print(len(h3indexset))
print(len(h3indexhashmap))

h3_index_set_to_file("test.geojson",set(h3indexhashmap))
